...
contract SHEART is
    ...
    Freezable
{
    string constant private _name = "STEEL HEART";
    string constant private _symbol = "SHEART";
        ...
        returns (bool success)
    {
        require(
            to != address(0),
            "SHEART/transfer : Should not send to zero address"
        );
        ...
        returns (bool success)
    {
        require(
            to != address(0),
            "SHEART/transferFrom : Should not send to zero address"
        );
        ...
        returns (bool success)
    {
        require(
            spender != address(0),
            "SHEART/approve : Should not approve zero address"
        );
